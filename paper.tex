...
\hypersetup{
 pdfauthor={},
 pdftitle={IEEE Conference Template in Emacs Org mode},
 pdfkeywords={},
 pdfsubject={},
...
\label{sec:orgd8129f9}
   \textbf{\textbf{The class file is designed for, but not limited to, six authors.}} A minimum of one author is required for all conference articles. Author names should be listed starting from left to right and then moving down to the 
